<template>
  <el-dialog
    ...
    <el-form-item label="¿â´æÊý" prop="stock">
      <el-input v-model="dataForm.stock" placeholder="¿â´æÊý"></el-input>
    </el-form-item>
    <el-form-item label="sku_name" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="sku_name"></el-input>
    </el-form-item>
    <el-form-item label="Ëø¶¨¿â´æ" prop="stockLocked">
      <el-input v-model="dataForm.stockLocked" placeholder="Ëø¶¨¿â´æ"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          stock: [
            { required: true, message: '¿â´æÊý不能为空', trigger: 'blur' }
          ],
          skuName: [
            { required: true, message: 'sku_name不能为空', trigger: 'blur' }
          ],
          stockLocked: [
            { required: true, message: 'Ëø¶¨¿â´æ不能为空', trigger: 'blur' }
          ]
        }
      }
    },
