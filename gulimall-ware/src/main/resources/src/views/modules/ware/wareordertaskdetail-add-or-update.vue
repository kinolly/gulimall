<template>
  <el-dialog
    ...
    <el-form-item label="¹ºÂò¸öÊý" prop="skuNum">
      <el-input v-model="dataForm.skuNum" placeholder="¹ºÂò¸öÊý"></el-input>
    </el-form-item>
    <el-form-item label="¹¤×÷µ¥id" prop="taskId">
      <el-input v-model="dataForm.taskId" placeholder="¹¤×÷µ¥id"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          skuNum: [
            { required: true, message: '¹ºÂò¸öÊý不能为空', trigger: 'blur' }
          ],
          taskId: [
