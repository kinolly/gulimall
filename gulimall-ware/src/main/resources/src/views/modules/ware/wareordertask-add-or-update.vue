<template>
  <el-dialog
    ...
    <el-form-item label="ÊÕ»õÈË" prop="consignee">
      <el-input v-model="dataForm.consignee" placeholder="ÊÕ»õÈË"></el-input>
    </el-form-item>
    <el-form-item label="ÊÕ»õÈËµç»°" prop="consigneeTel">
      <el-input v-model="dataForm.consigneeTel" placeholder="ÊÕ»õÈËµç»°"></el-input>
    </el-form-item>
    <el-form-item label="ÅäËÍµØÖ·" prop="deliveryAddress">
      <el-input v-model="dataForm.deliveryAddress" placeholder="ÅäËÍµØÖ·"></el-input>
    </el-form-item>
    <el-form-item label="¶©µ¥±¸×¢" prop="orderComment">
      <el-input v-model="dataForm.orderComment" placeholder="¶©µ¥±¸×¢"></el-input>
    </el-form-item>
    <el-form-item label="¸¶¿î·½Ê½¡¾ 1:ÔÚÏß¸¶¿î 2:»õµ½¸¶¿î¡¿" prop="paymentWay">
      <el-input v-model="dataForm.paymentWay" placeholder="¸¶¿î·½Ê½¡¾ 1:ÔÚÏß¸¶¿î 2:»õµ½¸¶¿î¡¿"></el-input>
    </el-form-item>
    <el-form-item label="ÈÎÎñ×´Ì¬" prop="taskStatus">
      <el-input v-model="dataForm.taskStatus" placeholder="ÈÎÎñ×´Ì¬"></el-input>
    </el-form-item>
    <el-form-item label="¶©µ¥ÃèÊö" prop="orderBody">
      <el-input v-model="dataForm.orderBody" placeholder="¶©µ¥ÃèÊö"></el-input>
    </el-form-item>
    <el-form-item label="ÎïÁ÷µ¥ºÅ" prop="trackingNo">
      <el-input v-model="dataForm.trackingNo" placeholder="ÎïÁ÷µ¥ºÅ"></el-input>
    </el-form-item>
    <el-form-item label="create_time" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="create_time"></el-input>
    </el-form-item>
    <el-form-item label="²Ö¿âid" prop="wareId">
      <el-input v-model="dataForm.wareId" placeholder="²Ö¿âid"></el-input>
    </el-form-item>
    <el-form-item label="¹¤×÷µ¥±¸×¢" prop="taskComment">
      <el-input v-model="dataForm.taskComment" placeholder="¹¤×÷µ¥±¸×¢"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          consignee: [
            { required: true, message: 'ÊÕ»õÈË不能为空', trigger: 'blur' }
          ],
          consigneeTel: [
            { required: true, message: 'ÊÕ»õÈËµç»°不能为空', trigger: 'blur' }
          ],
          deliveryAddress: [
            { required: true, message: 'ÅäËÍµØÖ·不能为空', trigger: 'blur' }
          ],
          orderComment: [
            { required: true, message: '¶©µ¥±¸×¢不能为空', trigger: 'blur' }
          ],
          paymentWay: [
            { required: true, message: '¸¶¿î·½Ê½¡¾ 1:ÔÚÏß¸¶¿î 2:»õµ½¸¶¿î¡¿不能为空', trigger: 'blur' }
          ],
          taskStatus: [
            { required: true, message: 'ÈÎÎñ×´Ì¬不能为空', trigger: 'blur' }
          ],
          orderBody: [
            { required: true, message: '¶©µ¥ÃèÊö不能为空', trigger: 'blur' }
          ],
          trackingNo: [
          ...
          wareId: [
            { required: true, message: '²Ö¿âid不能为空', trigger: 'blur' }
          ],
          taskComment: [
            { required: true, message: '¹¤×÷µ¥±¸×¢不能为空', trigger: 'blur' }
          ]
